...
class ProjectTaskTypeEntityForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dmx_project\Entity\ProjectTaskTypeEntityInterface $entity_type */
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\dmx_project\Entity\ProjectTaskTypeEntity::load',
      ],
