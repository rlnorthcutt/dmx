 ...
 */
class ProjectTaskForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        drupal_set_message($this->t('Created the task %entity_label.', $message_params ));
        break;

      default:
        drupal_set_message($this->t('Saved the task %entity_label.', $message_params));
    }
